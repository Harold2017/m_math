...
// original code from: https://github.com/weinkauf/Persistence1D

#ifndef M_MATH_M_P1D_H
#define M_MATH_M_P1D_H
        ...
        public:
            ...
            */
            ...
            /*!
                ...
                By default, all pairs are printed.
                @param[in] threshold		Threshold value for pair persistence.
            */
            void PrintResults(const double threshold = 0.0) const
            {
                if (threshold < 0)
                {
                ...
                else
                {
                    ...
                    GetPairedExtrema(pairs, threshold);
                    PrintPairs(pairs);
                }

                std::cout << "Global minimum value: " << GetGlobalMinimumValue()
                          << " index: " << GetGlobalMinimumIndex()
                          << std::endl;
            }
            ...
            */
            bool GetPairedExtrema(std::vector<TPairedExtrema> & pairs, const double threshold = 0) const
            {
            ...
            */
            bool GetExtremaIndices(std::vector<int> & min, std::vector<int> & max, const double threshold = 0) const
            {
